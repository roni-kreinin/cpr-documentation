...
*Clearpath Platform*: The *platform* refers to the vehicle that makes up the base of the robot. The platform is referred to by
the platform code to indicate the revision. For example, `A200` refers to Husky 2.0, and `J100` refers to Jackal 1.0.
